...
flow_table <- survey_data %>%
  ...
  mutate(x = fct_relevel(x, c("startcause", "endcause")),  # startcause'u birinci seviye olarak ayarla
         x = fct_recode(x, 
                        "Start \n cause" = "startcause",   # başlangıçtan sonra satır sonu (\n) ekle
                        "End \n cause"   = "endcause")
        )
