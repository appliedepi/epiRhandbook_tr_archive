...
Lets apply this to our ui. We also will want to use the `DT` pacakge here - this is a great package for making interactive tables from pre-existing data. We can see it being used for `DT::datatableOutput()` in this example.
