...
```{r, warning=F, message=F}
# Raporun bu tarihten itibaren verilerle çalıştırılmasını simüle etmek için "Rapor tarihi"ni ayarlayınreport_date <- as.Date("2020-06-10")

# Rapor tarihini yansıtacak takip verileri oluşturun.table_data <- followups_clean %>% 
